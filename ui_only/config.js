...
async function requireAuth(role = null) {
  ...
  if (localStorage.getItem('demo_mode') === 'true') {
    ...
    return {
      id: role === 'student' ? '11111111-1111-1111-1111-111111111111' : '00000000-0000-0000-0000-000000000000',
      name: role === 'student' ? 'Demo Student' : 'System Demo User',
      email: 'demo@marquee.io',
      role: role,
      enrollment_number: role === 'student' ? 'STU_DEMO_001' : 'DEMO_001'
    };
  }
